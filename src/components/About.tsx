        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 items-start">
          ...
          >
            <motion.div 
              ...
              className="relative"
            >
              <h3 className="text-3xl lg:text-4xl font-bold mb-6 text-primary tracking-tight">
                Backend Architect
              </h3>
            </motion.div>
            ...
            <div className="prose prose-lg max-w-none opacity-90">
              <p className="text-lg leading-relaxed mb-8">
                Spesialisasi saya adalah <span className="font-black text-foreground">Laravel Enterprise Stack</span> dengan{' '}
            ...
            >
              <div className="text-center p-6 rounded-2xl bg-secondary/30 backdrop-blur-sm border border-border/50 hover:border-primary/50 transition-colors">
                <div className="text-3xl lg:text-4xl font-bold text-primary mb-1 tracking-tighter">50+</div>
                <div className="text-sm text-muted-foreground font-semibold uppercase tracking-wider">Projects</div>
              </div>
              <div className="text-center p-6 rounded-2xl bg-secondary/30 backdrop-blur-sm border border-border/50 hover:border-primary/50 transition-colors">
                <div className="text-3xl lg:text-4xl font-bold text-emerald-500 mb-1 tracking-tighter">99.9%</div>
                <div className="text-sm text-muted-foreground font-semibold uppercase tracking-wider">Uptime</div>
              </div>
              <div className="text-center p-6 rounded-2xl bg-secondary/30 backdrop-blur-sm border border-border/50 hover:border-primary/50 transition-colors">
                <div className="text-3xl lg:text-4xl font-bold text-indigo-400 mb-1 tracking-tighter">5+</div>
          ...
          >
            <div className="p-8 lg:p-10 rounded-3xl bg-secondary/20 backdrop-blur-xl border border-border shadow-2xl transition-all">
